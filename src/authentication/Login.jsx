  ...
  return (
    <div className="w-full h-screen overflow-hidden flex items-center lg:gap-10 bg-white">
      ...
      <div className="w-full lg:w-[50%]">
        <h3 className="text-2xl lg:text-3xl pb-8 text-center">
          Incident Reporting System
        </h3>
        <form
          onSubmit={handleSubmit}
          className="w-full px-[5%] lg:px-0 lg:w-[400px] m-auto flex flex-col gap-4"
        >
          <h2 className="text-xl font-bold tracking-wide italic">
            Welcome Back!
          </h2>

          {successMessage && (
            <p className="text-green-600 text-xs tracking-wide">
              {successMessage}
            </p>
          )}
          {Object.keys(errors).map((key) => (
            <p key={key} className="text-red-600 text-xs tracking-wide">
              {errors[key]}
            </p>
          ))}
          ...
          <p className="text-xs tracking-wide text-center mt-5">
